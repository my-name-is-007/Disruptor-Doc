 ...
 * thread safe.
 * <p>
 * The {@link SequenceGroup#get()} and {@link SequenceGroup#orderedSet(long)} methods are lock free and can be
...
public final class SequenceGroup extends Sequence
{
     ...
     */
    @Override
    public void orderedSet(final long value)
    {
        final Sequence[] sequences = this.sequences;
        for (Sequence sequence : sequences)
        {
            sequence.orderedSet(value);
        }
    }
